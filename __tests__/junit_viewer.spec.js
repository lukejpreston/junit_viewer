...
var templates = ['default', 'bootstrap'];
templates.forEach(function (template) {
    describe('Parsing transforms XML to JSON with ' + template + ' template (generic folder)', function() {
        var folder = 'data/test'
        var parsed = parse(folder)
        var rendered = render(parsed, template)
    ...
    describe('Rendering transforms JSON (from parse) to HTML string with ' + template + ' template (generic folder)', function() {
    ...
    describe('No such file with ' + template + ' template', function() {
